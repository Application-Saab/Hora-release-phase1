...
const Home = ({ navigation }) => {
  ...
  const [service, setService] = useState([
    ...
    { id: '4', image: require('../../assets/fooddeliveryhome.png'), name: 'Food Delivery', openLink: 'CreateOrderFoodDelivery', category: "fooddelivery" },
  ...
  const openCat = (item) => {
    navigation.navigate(item.openLink, { category: item.category });  1  };
